...
public class PlayerController : MonoBehaviour
{
    ...
    void ShowEffect(Collision2D col, int num, float showTime, string tag,
        float getTime, int score)
    {
    ...
    void Move(KeyCode A, Vector2 v2, bool flip)
    {
        if(Input.GetKey(A))
        {
            sr.flipX = flip;
    ...
    void Update()
    {
        ...
        transform.position = new Vector2(
            Mathf.Clamp(transform.position.x, -2.9f, 2.9f),
